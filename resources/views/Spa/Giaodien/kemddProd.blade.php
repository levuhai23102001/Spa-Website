...
@section('title')
    <title>ELUV Spa - Sản phẩm ●︎ Kem dưỡng da</title>
@endsection
...
@section('products')
    ...
    <div style="margin-top: 150px" class="container">
        <div class="col-12">
            <div class="title-link">
                ...
                <a href="/eluvspa" class="tags">Trang chủ</a> / <a  href="{{url('san-pham')}}" class="tags">Sản phẩm</a> / <a  href="kem-duong-da" class="tags">Kem dưỡng da</a>
            </div>
        </div>
    </div>
    <div class="container my-4">
        ...
        <div class="row">
            <div class="col-md-2">  
                <ul style="border-right: 1px solid #8c8286;" class="list-group list-group-flush">
                    <li class="list-group-item">
                        <a href="kem-duong-da" class="act">Kem dưỡng da</a>
                    </li>
                    <li class="list-group-item">
            ...
            <div class="col-md-10">
                <div class="row">
                @foreach($kemduongda as $kdd)
                    <div class="col-md-4 col-sm-4 my-2">
                        <div class="card card-prod">
                            <img src="/img/product/{{$kdd->Prod_img}}" class="card-img-top" style="width:100%; height:225px; padding:35px 35px 0px 35px;">
                            <div class="card-body">
                                <h6 class="card-title cate-name">{{$kdd->CateName}}</h6>
                                <a href="{{$kdd->Slug_prod}}" class="prod-name">{{$kdd->ProdName}}</a>
                                <p class="price text-center pt-3">{{number_format($kdd->ProdPrice)." "."₫"}}</p>
                ...
                <div class="d-flex justify-content-center">
                    {{$kemduongda->render('Spa.Giaodien.pagination')}}
                </div>
            </div>
        </div>
    </div>
