...
@section('title')
    <title>ELUV Spa - Sản phẩm ●︎ Serum trị mụn</title>
@endsection
    ...
    <div style="margin-top: 150px" class="container">
        <div class="col-12">
            <div class="title-link">
                ...
                <a href="/eluvspa" class="tags">Trang chủ</a> / <a  href="{{url('san-pham')}}" class="tags">Sản phẩm</a> / <a  href="serum-tri-mun" class="tags">Serum trị mụn</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-2">  
                <ul style="border-right: 1px solid #8c8286;" class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <a href="serum-tri-mun" class="act">Serum trị mụn</a>
                    </li>
                    <li class="list-group-item">
            ...
            <div class="col-md-10">
                <div class="row">
                @foreach($serumtrimun as $serum)
                    <div class="col-md-4 my-2">
                        <div class="card card-prod">
                            <img src="/img/product/{{$serum->Prod_img}}" class="card-img-top" style="width:100%; height:225px; padding:35px 35px 0px 35px;">
                            <div class="card-body">
                                <h6 class="card-title cate-name">{{$serum->CateName}}</h6>
                                <a href="{{$serum->Slug_prod}}" class="prod-name">{{$serum->ProdName}}</a>
                                <p class="price text-center pt-3">{{number_format($serum->ProdPrice)." "."₫"}}</p>
                ...
                <div class="d-flex justify-content-center">
                    {{$serumtrimun->render('Spa.Giaodien.pagination')}}
                </div>
            </div>
        </div>
    </div>
