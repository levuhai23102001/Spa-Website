...
@section('title')
   <title>ELUV - Quản lý loại tin tức</title>
@endsection
                    ...
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Danh sách loại tin tức</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                  ...
                  <table class="table table-striped mydatatable" style="width: 100%; background-color: white;">
                      ...
                      <tbody>
                        @foreach($tip_Cate as $tipCate)
                          <tr>
                            <td>{{$tipCate->TipsCategory_ID}}</td>
                            <td>{{$tipCate->TipsCateName}}</td>
                            <td>{{$tipCate->Slug_cateTips}}</td>
                            <td class="text-right">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                  <a class="dropdown-item" href="edit-tipCate/{{$tipCate->TipsCategory_ID}}"><i class="fas fa-pencil-alt"></i> Edit</a>
                                  <a class="dropdown-item" href="del-tipCate/{{$tipCate->TipsCategory_ID}}"><i class="far fa-trash-alt"></i> Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
