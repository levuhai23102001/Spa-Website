...
@section('title')
   <title>ELUV - Thêm sản phẩm</title>
@endsection
        ...
        <div class="container mt--6">
            <div class="card">
                <div class="col-12 pt-5">
                    <h2 class="product">Thêm sản phẩm</h2>
                </div>
                    @if(count($errors) > 0)
                ...
                <div class="card-body">
                    <form action="add-prod" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="ProdName" class="form-control" id="name">
                        ...
                        <select id="ProdCate" class="form-control" name="Category_ID">
                            ...
                            @foreach($Prod_Cate as $prdCate)
                                <option value="{{$prdCate->Category_ID}}">{{$prdCate->CateName}}</option>
                            @endforeach
                        </select>
                        ...
                        <textarea name="ProdDecript" id="ProdDecript" class="form-control" rows="15"></textarea>
                        ...
                        <input type="date" name="NSX" class="form-control">
                        <label style="font-weight: 600; color: black; margin-top:5px;">Hạn sử dụng</label>
                        <input type="date" name="HSD" class="form-control">
