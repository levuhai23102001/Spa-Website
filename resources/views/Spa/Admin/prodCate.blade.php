...
@section('title')
   <title>ELUV - Quản lý loại sản phẩm</title>
@endsection
                  ...
                  <table class="table table-striped mydatatable" style="width: 100%; background-color: white;">
                      ...
                      <tbody>
                        @foreach($Prod_Cate as $prdCate)
                          <tr>
                            <td>{{$prdCate->Category_ID}}</td>
                            <td>{{$prdCate->CateName}}</td>
                            <td>{{$prdCate->Slug_cateProd}}</td>
                            <td class="text-right">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                  <a class="dropdown-item" href="edit-prodCate/{{$prdCate->Category_ID}}"><i class="fas fa-pencil-alt"></i> Edit</a>
                                  <a class="dropdown-item" href="del-prodCate/{{$prdCate->Category_ID}}"><i class="far fa-trash-alt"></i> Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
