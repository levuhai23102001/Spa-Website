                    ...
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Danh sách đặt dịch vụ</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                  ...
                  <table class="table table-striped mydatatable" style="width: 100%; background-color: white;">
                      ...
                      <tbody>
                        @foreach($booking as $bking)
                          <tr>
                            <td>{{$bking->Booking_ID}}</td>
                            <td>{{$bking->User_ID}}</td>
                            <td>{{$bking->SĐT}}</td>
                            <td>{{$bking->Branch}}</td>
                            <td>{{$bking->ServiceName}}</td>
                            <td>{{$bking->Status}}</td>
                            <td>{{$bking->Date_Bking}}</td>
                            <td class="text-right">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                  ...
                                  <a class="dropdown-item" href="del-booking/{{$bking->Booking_ID}}"><i class="far fa-trash-alt"></i> Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
