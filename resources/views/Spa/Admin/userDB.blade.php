...
@section('title')
   <title>ELUV - Quản lý khách hàng</title>
@endsection
              ...
              <table class="table align-items-center table-dark">
                ...
                <tbody class="list">
                  ...
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a style="border: 2px solid #ff3366;" class="avatar rounded-circle mr-3">
                          <img src="/img/users/{{$user->User_img}}">
                        </a>
                    ...
                    <td>
                      <span class="badge badge-dot mr-4">
                        <span class="status">{{$user->Birthday}}</span>
                      </span>
                    </td>
                    <td>
                      <span class="badge badge-dot mr-4">
                    ...
                    <td>
                      <span class="badge badge-dot mr-4">
                        <span class="status">{{$user->City}}</span>
                      </span>
                    </td>
                    <td>
                      <span class="badge badge-dot mr-4">
                        <span class="status">{{$user->Country}}</span>
                      </span>
                    </td>
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="edit-user/{{$user->User_ID}}"><i class="fas fa-pencil-alt"></i> Edit</a>
                          <a class="dropdown-item" href="del-user/{{$user->User_ID}}"><i class="far fa-trash-alt"></i> Delete</a>
                        </div>
                      </div>
                    </td>
                  </tr>
