...
@section('title')
   <title>ELUV - Quản lý dịch vụ</title>
@endsection
                      ...
                      <tbody>
                        @foreach($Services as $ser)
                          <tr>
                            ...
                            <td>                     
                              <img src="/img/service-img/{{$ser->Service_img}}" style="width: 46px; height: 46px">            
                            </td>
                            <td>{{$ser->PriceOneTime}}</td>
                            <td>{{$ser->AllInOne}}</td>
                            <td class="text-right">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                  <a class="dropdown-item" href="edit-sers/{{$ser->Service_ID}}"><i class="fas fa-pencil-alt"></i> Edit</a>
                                  <a class="dropdown-item" href="del-sers/{{$ser->Service_ID}}"><i class="far fa-trash-alt"></i> Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
