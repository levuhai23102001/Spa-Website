...
@section('title')
   <title>ELUV - Quản lý tin tức</title>
@endsection
                      ...
                      <tbody>
                        @foreach($Tips as $tip)
                          <tr>
                            ...
                            <td>{{$tip->TipsTitle}}</td>
                            <td>                     
                              <img src="/img/tips/{{$tip->Tips_img}}" style="width: 70px; height: 46px">            
                            </td>
                            <td>{{$tip->TipsCateName}}</td>
                            ...
                            <td class="text-right">
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                  <a class="dropdown-item" href="edit-tip/{{$tip->Tips_ID}}"><i class="fas fa-pencil-alt"></i> Edit</a>
                                  <a class="dropdown-item" href="del-tip/{{$tip->Tips_ID}}"><i class="far fa-trash-alt"></i> Delete</a>
                                </div>
                              </div>
                            </td>
                          </tr>
